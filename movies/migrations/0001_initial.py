    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.category', verbose_name='Катергория')),
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.actor', verbose_name='режиссёр')),
                ('genres', models.ManyToManyField(to='movies.genre', verbose_name='')),
            ],
            options={
                'verbose_name': 'Фильм',
